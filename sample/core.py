...
class core():
    def text_clean(text):
        ...
        :return text: string
        """
        # this try is to prevent crashes from unexpected characters
        try:
    ...
    def compute_dataset_score(path_raw = "../assets/articles1.csv", encoding="utf-8"):
        ...
        # uncomment for tests
        # rawdata = pd.read_pickle('../assets/raw_data_tests.pkl')
        # data = pd.read_pickle('../assets/prepared_data_tests.pkl')
